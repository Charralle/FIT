...
Garment.create!( {user_id: 1, category_id: pants.id, shape_id: cargo_shape.id, fabric_id: cargo_fab.id, detail_id: cargo_det.id, selected: true} )
Garment.create!( {user_id: 1, category_id: pants.id, shape_id: straight_shape.id, fabric_id: straight_fab.id, detail_id: straight_det.id, selected: true} )
Garment.create!( {user_id: 1, category_id: top.id, shape_id: turtleneck_shape.id, fabric_id: turtle_fab.id, detail_id: turtle_det.id, selected: true} )
Garment.create!( {user_id: 1, category_id: top.id, shape_id: bustier_shape.id, fabric_id: bustier_fab.id, detail_id: bustier_det.id, selected: true} )
