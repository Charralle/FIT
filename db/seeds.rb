...
Fabric.create({shape_id: cargo_shape.id, name: "Whitejeans", description: "100% Coton", code: "whitejeans"})
...
Fabric.create({shape_id: straight_shape.id, name: "Whitejeans", description: "100% Coton", code: "whitejeans"})
...
Fabric.create({shape_id: turtleneck_shape.id, name: "Tiedie", description: "100% Coton", code: "tiedie"})
...
Fabric.create({shape_id: bustier_shape.id, name: "Tiedie", description: "100% Coton", code: "tiedie"})
...
Fabric.create({shape_id: longblazer_shape.id, name: "Patchwork", description: "100% Coton", code: "patchwork"})
...
Detail.create({shape_id: cargo_shape.id, name: "Mushroom", description: "Le Detail 1, donne un style incroyable", code: "mushroom"})
...
Detail.create({shape_id: straight_shape.id, name: "Mushroom", description: "Le Detail 1, donne un style incroyable", code: "mushroom"})
...
Detail.create({shape_id: turtleneck_shape.id, name: "Silverring", description: "Le Detail 1, donne un style incroyable", code: "silverring"})
...
Detail.create({shape_id: bustier_shape.id, name: "Silverring", description: "Le Detail 1, donne un style incroyable", code: "silverring"})
